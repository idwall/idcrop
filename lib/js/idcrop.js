const IdCrop = (function() {
  ...
  const startResizing = function(event) {
    ...
    document.onmousemove = function(event) {
      ...
      let left = clip(
          crop_bounds.left - container_bounds.left - delta_x - crop_border * 2,
          e_boundary,
          w_boundary
        ),
        top = clip(
          crop_bounds.top - container_bounds.top - delta_y - crop_border * 2,
          n_boundary,
          s_boundary
        );
      ...
      let rel_max_width =
        ...
        rel_max_height =
          max_height - (crop_bounds.top - container_bounds.top - bg_image.top);
